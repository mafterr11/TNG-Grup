                ...
                <div key={serviciuIndex} className='w-[90%]'>
                  <Link href={serviciu.path}>
                    <Card className='border-2 border-accent hover:bg-grey/85 rounded-xl relative group mx-auto md:w-[60%] xl:w-full'>
                      <CardContent className='flex flex-col gap-y-6 items-center justify-start p-6 bg-grey bg-opacity-[0.93] min-h-[310px] md:min-h-[350px] xl:min-h-[310px]  hover:scale-[0.98] rounded-[3%]'>
