...
const Footer = () => {
  return (
    <footer className="flex flex-col-reverse xl:flex-row items-center justify-evenly mx-auto w-full gap-y-8 xl:gap-x-20 px-5 py-12 border-t-2 border-accent relative z-[2] bg-black">
