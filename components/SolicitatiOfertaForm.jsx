...
export default function SolicitatiOfertaForm() {
  return (
    <div className='max-w-lg mx-auto my-10 p-6 bg-grey shadow-md rounded-lg'>
      <h2 className='text-xl font-semibold'>Solicitați o ofertă</h2>
      <p className='text-gray-600'>
        Partenerul dumneavoastră în realizarea casei de vis
      </p>
      <form className='mt-4 space-y-4'>
        ...
        <div>
          ...
          <Select>
            ...
            <SelectContent position='popper'>
              ...
              <SelectItem value='Altceva666'>Altceva</SelectItem>
            </SelectContent>
          </Select>
        </div>
        <div>
        ...
        <div>
          ...
          <Select>
            ...
            <SelectContent position='popper'>
              <SelectItem value='"Urmează să cumpăr terenul'>
                "Urmează să cumpăr terenul
              </SelectItem>
              <SelectItem value='Este planificată elaborarea proiectului'>
                Este planificată elaborarea proiectului
              </SelectItem>
              <SelectItem value='Sunt în proces de a căpăta autorizația'>
                Sunt în proces de a căpăta autorizația
              </SelectItem>
              <SelectItem value='Am obținut autorizația'>
                Am obținut autorizația
              </SelectItem>
              <SelectItem value='Construcția a început deja'>
                Construcția a început deja
              </SelectItem>
            </SelectContent>
          </Select>
        </div>
